                  ...
                  <div class="card shadow" aria-labelledby="city-form-title">
                    <div class="card-header form-card-header">
                      <div class="form-card-header__title">
                        <strong id="city-form-title"><?= __('Add City') ?></strong>
                        <small class="d-block"><?= __('New city') ?></small>
                      </div>
                        ...
                        <div class="tab-pane fade show active" id="tab-basic" role="tabpanel" aria-labelledby="tab-basic-btn" tabindex="0">
                          <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-9">
                              <?= $this->Form->control('shortname', ['label' => false, 'class' => 'form-control', 'autofocus' => true, 'templates' => $containerLess]) ?>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <div class="col-12 col-md-2 text-start text-md-end">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-9">
                              <?= $this->Form->control('zip', ['label' => false, 'class' => 'form-control', 'templates' => $containerLess]) ?>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <div class="col-12 col-md-2 text-start text-md-end">
                            ...
                            <div class="col-12 col-md-9">
                              <?= $this->Form->control('lat', ['label' => false, 'class' => 'form-control', 'templates' => $containerLess]) ?>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <div class="col-12 col-md-2 text-start text-md-end">
                            ...
                            <div class="col-12 col-md-9">
                              <?= $this->Form->control('lng', ['label' => false, 'class' => 'form-control', 'templates' => $containerLess]) ?>
                            </div>
                          </div>
                        </div>
