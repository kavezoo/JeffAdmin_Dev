                  ...
                  <div class="card shadow" aria-labelledby="ordersItem-form-title">
                    <div class="card-header form-card-header">
                      <div class="form-card-header__title">
                        <strong id="ordersItem-form-title"><?= __('Add Orders Item') ?></strong>
                        <small class="d-block"><?= __('New orders item') ?></small>
                      </div>
                        ...
                        <div class="tab-pane fade show active" id="tab-basic" role="tabpanel" aria-labelledby="tab-basic-btn" tabindex="0">
                          <div class="row mb-3">
                            <div class="col-12 col-md-2 text-start text-md-end">
                              <?= $this->Form->label('order_id', __('Order') . ':', ['class' => 'form-control-label fw-bold']) ?>
                            </div>
                            <div class="col-12 col-md-9">
                              <div class="select-with-action">
                                <?= $this->Form->control('order_id', ['label' => false, 'options' => $orders, 'empty' => __('Please select'), 'class' => 'form-select', 'data-tom-select' => true, 'templates' => $containerLess]) ?>
                          ...
                          <div class="row mb-3">
                            <div class="col-12 col-md-2 text-start text-md-end">
                              <?= $this->Form->label('item_id', __('Item') . ':', ['class' => 'form-control-label fw-bold']) ?>
                            </div>
                            <div class="col-12 col-md-9">
                              <div class="select-with-action">
                                <?= $this->Form->control('item_id', ['label' => false, 'options' => $items, 'empty' => __('Please select'), 'class' => 'form-select', 'data-tom-select' => true, 'templates' => $containerLess]) ?>
                                <button type="button" class="btn btn-outline-secondary select-with-action__btn" aria-label="<?= h(__('More options')) ?>" data-bs-toggle="tooltip" data-bs-title="<?= h(__('More options')) ?>">
                                  <?= $this->Icon->outline('dots') ?>
                                </button>
                              </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-9">
                              <?= $this->Form->control('comment', ['label' => false, 'class' => 'form-control', 'templates' => $containerLess]) ?>
                            </div>
                          </div>
                        </div>
